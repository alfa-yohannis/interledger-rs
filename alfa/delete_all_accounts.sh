...
cargo run --bin ilp-cli -- --node http://127.0.0.1:7770 accounts delete david --auth hi_alice
cargo run --bin ilp-cli -- --node http://127.0.0.1:7770 accounts delete erin --auth hi_alice
